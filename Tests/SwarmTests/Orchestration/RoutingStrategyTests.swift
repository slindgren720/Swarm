...
// MARK: - KeywordRoutingStrategyTests
...
struct KeywordRoutingStrategyTests {
    ...
    func matchesByKeyword() async throws {
        let strategy = KeywordRoutingStrategy()
    ...
    func matchesByMultipleKeywords() async throws {
        let strategy = KeywordRoutingStrategy()
        let agents = createTestAgents()
    ...
    func matchesByCapability() async throws {
        let strategy = KeywordRoutingStrategy()
        let agents = createTestAgents()
    ...
    func matchesByAgentName() async throws {
        let strategy = KeywordRoutingStrategy()
        let agents = createTestAgents()
...
// MARK: - RoutingStrategyProtocolTests
...
struct RoutingStrategyProtocolTests {
    ...
    func keywordStrategyConformsToProtocol() {
    ...
    func routingStrategyIsSendable() async throws {
        let strategy = KeywordRoutingStrategy()
