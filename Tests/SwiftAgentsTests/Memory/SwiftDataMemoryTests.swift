...
struct SwiftDataMemoryTests {
    ...
    func testInMemoryInit() async throws {
    ...
    func testCustomConversationId() async throws {
    ...
    func testMaxMessagesLimit() async throws {
    ...
    func testAddSingleMessage() async throws {
        let memory = try makeInMemoryMemory()
    ...
    func testTrimsToMaxMessages() async throws {
    ...
    func testUnlimitedMessages() async throws {
    ...
    func testMessageCountForConversation() async throws {
        let container = try PersistedMessage.makeContainer(inMemory: true)
    ...
    func testDiagnosticsUnlimited() async throws {
        let memory = try makeInMemoryMemory(maxMessages: 0)
    ...
    func testInMemoryFactory() async throws {
